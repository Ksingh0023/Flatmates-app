...
### Case 4: The `parseSplitDetails` function couldn't handle "Rohan 700; Priya 400"
...
**What I changed:** The regex was correct for simple names but I added defensive checking — if the matched "name" contains digits or looks malformed, skip it. Also ensured guest names are handled separately before split detail parsing.
